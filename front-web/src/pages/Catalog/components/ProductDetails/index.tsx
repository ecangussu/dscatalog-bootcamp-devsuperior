      ...
      <div className="card-base border-radius-20 product-details">
        ...
        <div className="row">
          ...
          <div className="col-6 product-details-card">
            ...
            para obter mais espaço e trabalhar com os itens que você deseja. Além disso, todas 
            as notificações e principais configurações são reunidas em uma única tela de fácil acesso.
            </p>
          </div>
        </div>
      </div>
